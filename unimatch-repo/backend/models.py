...
class User(Base):
    ...
    needs_aid = Column(Boolean, nullable=True)        # None = не указано, True/False = явный ответ в онбординге
...
class University(Base):
    ...
    # Финансовая помощь / стипендии
    aid_level = Column(String, default="Medium")   # "High" | "Medium" | "Low" — щедрость need-based aid
    aid_merit = Column(Boolean, default=False)     # есть ли merit-стипендии
    aid_note = Column(String, default="")          # короткое пояснение для карточки/страницы вуза
